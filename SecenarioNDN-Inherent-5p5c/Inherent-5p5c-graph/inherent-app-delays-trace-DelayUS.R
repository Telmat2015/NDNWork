...
jayapura<-Node.jayapura$DelayUS
surabaya<-Node.surabaya$DelayUS
manado<-Node.surabaya$DelayUS
palangkaraya<-Node.surabaya$DelayUS
palembang<-Node.surabaya$DelayUS

png("/home/ardi/Desktop/Rcrot/inherent-app-delays-trace-delayUS.png", width=1280, height=720)
