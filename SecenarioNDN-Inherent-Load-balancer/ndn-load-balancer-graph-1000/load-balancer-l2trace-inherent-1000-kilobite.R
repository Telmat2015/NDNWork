...
data5<-Drop.data5$KilobytesRaw
data10<-Drop.data10$KilobytesRaw
data15<-Drop.data15$KilobytesRaw
data20<-Drop.data20$KilobytesRaw

png("/home/ardi/Desktop/Rinfix/load-balancer-1000/load-balancer-l2trace-inherent-1000-KilobytesRaw.png", width=1280, height=720)
