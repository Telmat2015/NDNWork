...
data5<-Drop.data5$PacketsRaw
data10<-Drop.data10$PacketsRaw
data15<-Drop.data15$PacketsRaw
data20<-Drop.data20$PacketsRaw

png("/home/ardi/Desktop/Rinfix/load-balancer-1000/load-balancer-l2trace-inherent-1000-PacketsRaw.png", width=1280, height=720)
