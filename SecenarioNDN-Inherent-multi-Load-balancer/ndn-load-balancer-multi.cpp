...
main(int argc, char* argv[])
{
  ...
  Ptr<Node> producer4 = Names::Find<Node>("serang");
  ...
  consumerNodes.Add(Names::Find<Node>("makasar"));
  ...
  // node Surabaya
  StrategyChoiceHelper::Install<nfd::fw::RandomLoadBalancerStrategy>(Names::Find<Node>("surabaya"),prefix);
  StrategyChoiceHelper::Install<nfd::fw::RandomLoadBalancerStrategy>(Names::Find<Node>("bandar-lampung"),prefix);
  StrategyChoiceHelper::Install<nfd::fw::RandomLoadBalancerStrategy>(Names::Find<Node>("jkt-ui"),prefix);
  StrategyChoiceHelper::Install<nfd::fw::RandomLoadBalancerStrategy>(Names::Find<Node>("medan"),prefix);
