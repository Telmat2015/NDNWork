...
main(int argc, char* argv[])
{
  ...
  StrategyChoiceHelper::InstallAll (prefix1, "/localhost/nfd/strategy/client-control");
  StrategyChoiceHelper::InstallAll (prefix2, "/localhost/nfd/strategy/client-control");
  StrategyChoiceHelper::InstallAll (prefix3, "/localhost/nfd/strategy/client-control");
  StrategyChoiceHelper::InstallAll (prefix4, "/localhost/nfd/strategy/client-control");
  StrategyChoiceHelper::InstallAll (prefix5, "/localhost/nfd/strategy/client-control");
  ...
  L2RateTracer::InstallAll("/home/bertopeng17/ndnSIM/ns-3/data-tracer-inherent/different-strategy-forwading/strategy-clientcontrol-5s.txt");
