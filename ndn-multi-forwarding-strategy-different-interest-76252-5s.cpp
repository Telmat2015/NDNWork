...
main(int argc, char* argv[])
{
  ...
  StrategyChoiceHelper::InstallAll (prefix2, "/localhost/nfd/strategy/client-control");
  StrategyChoiceHelper::InstallAll (prefix3, "/localhost/nfd/strategy/ncc");
  StrategyChoiceHelper::InstallAll (prefix4, "/localhost/nfd/strategy/client-control");
  StrategyChoiceHelper::InstallAll (prefix5, "/localhost/nfd/strategy/ncc");
  // Install NDN applications
  AppHelper consumerHelper("ns3::ndn::ConsumerCbr");
  consumerHelper.SetPrefix(prefix1);
  consumerHelper.SetAttribute("Frequency", StringValue("700")); // 1000 interests a second
  consumerHelper.Install(consumer1);
  consumerHelper.SetPrefix(prefix2);
  consumerHelper.SetAttribute("Frequency", StringValue("600")); // 1000 interests a second
  consumerHelper.Install(consumer2);
  consumerHelper.SetPrefix(prefix3);
  consumerHelper.SetAttribute("Frequency", StringValue("200")); // 1000 interests a second
  ...
  L2RateTracer::InstallAll("/home/bertopeng17/ndnSIM/ns-3/data-tracer-inherent/different-strategy-forwading/strategy-different-interest-76252-5s.txt");
